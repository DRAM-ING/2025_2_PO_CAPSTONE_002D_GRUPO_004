...
export default function CreateItem() {
  ...
  useEffect(() => {
    const loadRepuestos = async () => {
      try {
        const r = await fetch("/api/proxy/inventory/repuestos/?activo=true", {
          credentials: "include",
        });
        if (r.ok) {
  ...
  return (
    <div className="p-6 space-y-6 max-w-2xl mx-auto">
      <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Agregar Ítem</h1>
